...
<head>
  ...
  <title>Instructor Order History | Edurock - Education LMS Template</title>
  <link
    rel="shortcut icon"
    type="image/x-icon"
                ...
                <table class="w-full text-left">
                  <thead
                    ...
                    <tr>
                      ...
                      <th class="px-5px py-10px md:px-5">Prenome</th>
                            ...
                            <form action="/Status" method="POST">
                              ...
                              <p class="text-xs">
                                <button
                                  type="submit"
                                  name="statusbutton"
                                  class="h-22px inline-block px-7px bg-yellow-400 leading-22px font-bold text-whiteColor rounded-md">
                                  suspendu</button>
                              </p>
                            </form>
                          <?php
                            ...
                            <form action="/supprime/<?= $row->getId() ?>" method="POST">
                              ...
                              <p class="text-xs">
                                <button
                                  type="submit"
                                  name="suprbutton"
                                  class="h-22px inline-block px-7px bg-red-400 leading-22px font-bold text-whiteColor rounded-md">
                                  supprimé</button>
                              </p>
                            </form>
                          </td>
...
<!-- Mirrored from html.themewin.com/edurcok-preview-tailwind/edurock/pages/dashboards/instructor-order-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jan 2025 14:27:53 GMT -->
