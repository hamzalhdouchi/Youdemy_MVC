...
<body>
  ...
  <div id="modal" class="flex inset-0 h-screen bg-gray-900 bg-opacity-50  justify-center items-center z-50">
    ...
    <div class="bg-gradient-to-br from-gray-100 to-gray-300 p-8 rounded-lg shadow-lg max-w-[50vw] mx-auto">
      <h2 class="text-2xl font-semibold text-center text-gray-800 mb-6">Modifier Categorie</h2>
      <!-- Form -->
      <form action="/setModification" method="POST" class="space-y-4 w-[40vw] h-[40vh] overflow-y-auto p-4 bg-gray-100 rounded-lg">
        <!-- Tag Name Input -->
        <input type="hidden" name="id" value="<?= $categoreiMO->getIdC() ?>">
        <div id="formTage">
          <!-- Champ "Tag Name" -->
          <div class="relative mb-4">
            ...
            <input
              type="text"
              name="categorie_name"
              value="<?= $categoreiMO->getNomCategorie() ?>"
              id="tag_name"
          ...
          <div class="relative mb-4">
            ...
            <input
              type="text"
              name="categorie_slogan"
              value="<?= $categoreiMO->getSlogan() ?>"
              id="tag_color"
        ...
        <div class="flex justify-center items-center">
          <button type="submit" name="ModifierCategorei" class="w-[10vw] py-2 text-sm text-white bg-blue-600 rounded-md shadow-md hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:outline-none">
            Submit
          </button>
        </div>
      </form>
