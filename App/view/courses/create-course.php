            ...
            <ul class="flex gap-1 justify-center">
              <li>
                <a
                  ...
                  class="text-lg text-blackColor2 dark:text-blackColor2-dark">Dachbord <i class="icofont-simple-right"></i></a>
              </li>
              <li>
                <span
                                          ...
                                          <div>
                                            ...
                                            <div
                                              ...
                                              <select
                                                ...
                                                <?php
                                                foreach ($categoreis as $categoryCoursePair):
                                                  $categorie = $categoryCoursePair[0];
                                                  $cour = $categoryCoursePair[1];
                                                ?>
...
<!-- Mirrored from html.themewin.com/edurcok-preview-tailwind/edurock/pages/dashboards/create-course.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jan 2025 14:27:43 GMT -->
