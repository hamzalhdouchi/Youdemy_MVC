                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-7xl mx-auto">
                  ...
                  <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex items-center justify-between">
                      <div>
                        <p class="text-sm text-gray-500">Nombre des Cours</p>
                        <p class="text-3xl font-semibold mt-1"><?= $totalCours ?></p>
                      </div>
                  ...
                  <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex items-center justify-between">
                      <div>
                        <p class="text-sm text-gray-500">Total Etudeint Inscrption</p>
                        <p class="text-3xl font-semibold mt-1"><?= $totalEtudiant ?></p>
                      </div>
